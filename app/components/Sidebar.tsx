  ...
  const contenu = (
    <div className="sidebar">
      ...
      <div style={{ padding: "1.5rem 1.25rem 1rem", borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
        ...
        {/* L'Honorable IK */}
        <div style={{ marginTop: "1rem", padding: "10px 12px", background: "rgba(255,255,255,0.08)", borderRadius: 10, borderLeft: "3px solid rgba(200,149,26,0.8)" }}>
          <div style={{ fontSize: 11, color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: 3 }}>Sous la direction de</div>
          <div style={{ color: "#f0c060", fontWeight: 700, fontSize: 13.5, fontFamily: "'Syne', sans-serif" }}>L'Honorable IK</div>
          <div style={{ color: "rgba(255,255,255,0.55)", fontSize: 11.5, marginTop: 2 }}>Directeur du Projet</div>
        </div>
      </div>
